...
dolares_ts <- ts(dolares$dol, start = c(2010,1), frequency = 12)
...
```{r warning=FALSE}
#GRAFICO ACCIDENTES
plot.ts(dolares_ts_full,ylab='Cantidad de accidentes',xlab="Periodo",main="Cantidad de accidentes de transito por mes\n(2000 - 2019)", lty=5,col="darkgray",bty="l",lwd=3)
...
autoplot(dolares_ts_full)+
 # geom_point(Month)+
  ...
  labs(title = "Cantidad de accidentes de transito por mes\n(2000 - 2019)",
...
seasonplot(dolares_ts_full,col=viridis::viridis(20),year.labels=TRUE, main = "Cantidad de accidentes de transito por mes y año\n(2000 - 2019)")

monthplot(dolares_ts_full,col="blue", main= "Cantidad de accidentes de transito por mes\n(2000 - 2019)")
...
plot(as.ts(decompose_dolares_full$seasonal), xlab="", ylab="Componente estacional", main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
plot(as.ts(decompose_dolares_full$trend), xlab="", ylab="Componente tendencia",  main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
plot(as.ts(decompose_dolares_full$random), xlab="", ylab="Componente aleatorio",  main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
...
plot(as.ts(decompose_dolares_full2$seasonal), xlab="", ylab="Componente estacional", main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
plot(as.ts(decompose_dolares_full2$trend), xlab="", ylab="Componente tendencia",  main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
plot(as.ts(decompose_dolares_full2$random), xlab="", ylab="Componente aleatorio",  main= "Activo neto de los fondos del mercado de dinero\n(2001 - 2020)")
plot(decompose_dolares_full, xlab="")
