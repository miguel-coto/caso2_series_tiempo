...
```{r}
plotBMRBoxplots(bmr, measure = mae, order.lrn = getBMRLearnerIds(bmr))
plotBMRBoxplots(bmr, measure = mape, order.lrn = getBMRLearnerIds(bmr))
plotBMRBoxplots(bmr, measure = rmse, order.lrn = getBMRLearnerIds(bmr))
